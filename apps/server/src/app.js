...
app.get('/api/health', (req, res) => res.json({ status: 'ok', database: mongoReady() ? 'ready' : 'demo-fallback', ai: config.aiApiKey ? 'configured' : 'fallback-only', aiProvider: config.aiProvider, aiModel: config.aiModel }));
