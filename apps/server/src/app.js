...
app.get('/api/health', (req, res) => res.json({ status: 'ok', database: mongoReady() ? 'ready' : 'demo-fallback', ai: config.aiApiKey ? 'configured' : 'fallback-only', aiModel: config.aiModel }));
